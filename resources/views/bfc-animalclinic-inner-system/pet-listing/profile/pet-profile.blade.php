...
@endif
<!-- Pet Info Container -->
<div class="w-11/12 mx-auto pb-5 border-2 border-gray-800 rounded-lg shadow-lg bg-gray-100 bg-opacity-90">

    <!-- Header -->
    <div class="bg-primary text-white p-6 relative text-center">
        <div class="absolute top-6 left-6 flex items-center space-x-2">
            <a href="{{ route('admin.pet-listings') }}"
...
@include('bfc-animalclinic-inner-system.pet-listing.profile.edit-pet')
@include('bfc-animalclinic-inner-system.pet-listing.profile.delete-pet')
@include('bfc-animalclinic-inner-system.pet-listing.profile.add-health')
@include('bfc-animalclinic-inner-system.pet-listing.profile.add-vaccine')
@include('bfc-animalclinic-inner-system.pet-listing.profile.add-signature')
